      ...
      ...(isReasoningModel
        ? {
            reasoning: {
              ...
              // DeepSeek-V4 backs free ASK + free agent; `xhigh` ran an
              // open-ended max-effort think pass before the first token (1-4s
              // of TTFT) — the exact opposite of the latency intent above.
