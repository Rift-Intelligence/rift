        ...
        {operation.fields.map((f) => {
          ...
          return (
            <div key={f.id}>
              ...
              {f.type === "text" && (
                <div className="flex items-center gap-2 rounded-lg border border-input bg-background px-2.5 py-2 transition-colors focus-within:border-primary">
                  {FieldIcon && (
              ...
              {f.type === "textarea" && (
                <textarea
                  ...
                  rows={4}
                  className={cn(
                    "w-full resize-y rounded-lg border border-input bg-background px-2.5 py-2 text-[13px] text-foreground outline-none transition-colors focus:border-primary placeholder:text-muted-foreground/60",
                    f.mono && "font-mono",
                  )}
                />
              )}
