          ...
          <>
            <DialogHeader className="flex flex-col gap-4 text-left sm:text-left">
              ...
              <DialogDescription className="sr-only">
                How the RIFT referral program works and what activity is
              ...
              <ul className="flex list-disc flex-col gap-2 px-5">
                <li>
                  <span className="text-muted-foreground text-sm">
                    This promotion is available to new RIFT users who sign up
                    through your link only — we want to share RIFT with fresh
                ...
                <li>
                  <span className="text-muted-foreground text-sm">
                    ...
                    and subscribes to any paid RIFT plan. No credit is granted
