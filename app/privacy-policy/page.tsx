        ...
        <div className="container mx-auto max-w-2xl space-y-6 rounded-[14px] border border-white/10 bg-white/[0.03] px-4 py-8 backdrop-blur-sm sm:px-8">
          ...
          <div className="mt-4 text-lg leading-relaxed text-card-foreground">
            ...
            <ul className="list-inside list-decimal">
              <li className="mb-3">
                <strong>Acknowledgement of Beta Service:</strong> You
                acknowledge that the Service is provided on a beta basis and may
                contain errors, inaccuracies, or vulnerabilities, including
                those related to privacy and data security. Your use of the
                Service signifies your understanding and acceptance of these
                risks.
              </li>
              <li className="mb-3">
                <strong>Information We Collect:</strong> We may collect and
                store any information you provide to us or that we collect in
                connection with your use of the Service. This may include, but
                is not limited to, personal information such as your email
                address and any data or content you create, upload, or share
                through the Service, including but not limited to penetration
                testing results, vulnerability reports, and security
                assessments.
              </li>
              <li className="mb-3">
                <strong>How We Use Your Information:</strong> The information we
                collect is used to provide, maintain, protect, and improve the
                Service; to develop new services; and to protect us and our
                users. We also use this information to offer tailored content
                and improve our AI-powered penetration testing capabilities.
              </li>
              <li className="mb-3">
              ...
              <li className="mb-3">
                <strong>Privacy and Beta Service Considerations:</strong> While
                we implement reasonable privacy protections for your data, you
                acknowledge that the Service is in beta phase and may have
                inherent limitations in its privacy and security measures. We
                are committed to protecting your privacy and continuously
                improving our security practices, but we cannot guarantee the
                same level of protection as a production service. By using the
                Service, you understand these limitations while we work to
                enhance our privacy and security measures.
              </li>
              <li className="mb-3">
                <strong>Security:</strong> We strive to use commercially
                acceptable means to protect your information, but we cannot
                guarantee its absolute security. Your use of the Service
                signifies your agreement that the risk of any data breaches or
                security vulnerabilities is borne solely by you.
              </li>
              <li className="mb-3">
